function [HistoSave] = HistCDF_PlotSave(HomePath, Image, ImageDenote)
%%%%%%%
% This function is for generating and saving:
%	1. output image
%	2. histogram and its normalized CDF of the output image 
%%%%%%%
...
% Setting output graph size and format
scale = 2;
