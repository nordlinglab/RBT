...
- Cheng-Hui Chen & Torbjörn E.M. Nordling (2025). Rank-based transformation algorithm for image contrast adjustment. Signal Processing: Image Communication, 117432. DOI: [10.1016/j.image.2025.117432](https://doi.org/10.1016/j.image.2025.117432)
- Cheng-Hui Chen & Torbjörn E.M. Nordling (2023). Rank-based Transformation Algorithm for Image Contrast Adjustment. Authorea (TechRxiv) Preprints. DOI: [10.36227/techrxiv.22952354.v3](https://www.techrxiv.org/doi/full/10.36227/techrxiv.22952354.v3)
- Cheng-Hui Chen & Torbjörn E.M. Nordling (2025). Rank-based Transformation for Image Contrast Adjustment Enhances Cell Segmentation, Research Square Preprints. DOI: [10.21203/rs.3.rs-6886043](https://doi.org/10.21203/rs.3.rs-6886043)
